 ...
 *
 * <pre>
 * 문자를 변형해주는 클래스 즉, 특수문자가 올경우 문자/숫자 형태로 변형해서 해킹을 방지한다.
 * </pre>
 *
 * @author sunny
 * @since 2020. 9. 4.
...
public class HtmlCharacterEscapes extends CharacterEscapes {
	...
	public HtmlCharacterEscapes() {
        ...
        * */
        ...
        Map<CharSequence, CharSequence> customEscapeMap = Collections.unmodifiableMap(customMap);
        ...
        translator = new AggregateTranslator(
                ...
                new LookupTranslator(customEscapeMap)
        );
